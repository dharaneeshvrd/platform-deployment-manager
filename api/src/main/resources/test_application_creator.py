...
class ApplicationCreatorTests(unittest.TestCase):
    ...
    def test_create_application(self, cmd_mock, dist_mock, copy_mock, tar_mock, os_mock, shutil_mock, spur_ssh,
                                ...
                                os_sys_mock, dt_mock, hive_mock, hbase_mock, time_mock):
        time_mock.return_value = 12345.123
    ...
    @patch('requests.put')
    @patch('requests.get')
    def test_start_application(self, get_mock, put_mock, exec_ssh_mock):
        creator = ApplicationCreator(self.config, self.environment, self.service)
        get_mock.return_value.json.return_value = {"apps": {"app": []}}
