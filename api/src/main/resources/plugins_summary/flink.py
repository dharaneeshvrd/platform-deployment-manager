...
from plugins_summary.base_common import Common

class FlinkSummary(Common):

    def get_component_type(self):
        return 'flink'

    def yarn_handler(self, yarn_data):
        '''
    ...
    def _job_handler(self, url):
        ...
        try:
            url = '%s%s' % (url, 'jobs')
            job_list_resp = requests.get(url)
